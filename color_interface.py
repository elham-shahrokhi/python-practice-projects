# Function that returns ANSI escape codes for terminal text coloring
def colorChange(color):
  if color == "red":
    return ("\033[31m")
  elif color == "white":
    return ("\033[0m")  # Resets to default (usually white)
  elif color == "blue":
    return ("\033[34m")
  elif color == "yellow":
    return ("\033[33m")
...
# Creating a colorful title banner for the music app
...
# Displaying song title and artist name with formatting
...
# Displaying buttons with different alignments and colors
...
# Welcome screen for a mock social network interface
text = "WELCOME TO"
